...
export const Route = createFileRoute("/auth")({
    head: () => ({
        meta: [
            ...
            {
                name: "description",
                content: "تسجيل دخول لوحة إدارة كود كرافت."
            },
...
function AuthPage() {
    ...
    const handleEmail = async (e: React.FormEvent) => {
        ...
        setBusy(true);
        try {
            // ✅ تحقق من البيانات الثابتة للمدير (دخول فوري بدون Supabase)
            if (email === "bela@admin.com" && password === "147852") {
            ...
            // ✅ باقي المستخدمين يعملون عبر Supabase
            if (mode === "signup") {
                ...
                toast.success(
                    "تم إنشاء الحساب! إن لم تُمنح صلاحية المدير بعد، تواصل مع المالك."
                );
            } else {
